...
function pugpig_send_itunes_edition_credentials($appStorePassword, $subscriptionPrefix, $allowedSubscriptionArray, $binaryReceipt, $secret,  $proxy_server = '', $proxy_port = '') {
  global $iTunesErrorCodes;
  $itunesUrl = '';
  $jsonResult = NULL;
  $jsonReceipt = NULL;
  ...
  if ($status == 0) {
    ...
    $username = sha1(mt_rand()); // TODO: do we need a more secure random number?
